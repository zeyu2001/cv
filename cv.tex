...
\begin{resumeSubHeadingList}
  ...
  \resumeSubheading
    {Hacktron AI}{Jul. 2025 -- Present}
    {Co-Founder \& CEO}{SF, London, Singapore}
    \begin{resumeItemList}
      \resumeItem{First investment from Project Europe, a pre-seed accelerator
                  backed by 20VC, Point Nine and Adjacent.}
      \resumeItem{Leading a team of engineers and designers to build an AI
                  pentester \& next-gen AppSec product.}
      \resumeItem{Raised \$2.6M from top investors in the U.S. and Europe, and
                  strategic angels like Charles Songhurst (Meta board member)}
    \end{resumeItemList}
    \vspace{2pt}

  \resumeSubheading
    {Cure53}{May 2023 -- Jun. 2025}
    {Senior Security Engineer}{Berlin, Germany (Remote)}
    \begin{resumeItemList}
