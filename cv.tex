...
\resumeItem{Notion + Jupyter Notebooks for STEM students.
	Runnable code blocks, intuitive math editor, interactive graphs, etc.} \resumeItem{Built core features from scratch as a solo developer.
	Now leading a team of 4 engineers to launch and scale the product.
}
\resumeItem{Next iteration of EduAble (below).
