...
\resumeItem{Built secure-by-default components used by developers in production systems and our starter kit template, making application
	security easy and invisible.
	Spotted and remediated a Next.js 0-day vulnerability through these components.
}
\resumeItemListEnd
\vspace{2pt}
