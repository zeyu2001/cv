...
\resumeItem{Notion + Jupyter Notebooks for STEM students.
	Runnable code blocks, intuitive math editor, interactive graphs, etc.} \resumeItemListEnd \resumeProjectHeading {\link{https://github.com/zeyu2001/EduAble}{\textbf{EduAble}} $|$ \emph{Next.js $\cdot$ TailwindCSS $\cdot$ PostgreSQL $\cdot$ Vercel $\cdot$ OpenAI API}}{} \resumeItemListStart \resumeItem{2nd Place @ Cambridge Generative AI Hackathon 2024, Finalist @ Fitzelerate 2024} \resumeItem{STEM notetaking app with real-time audio transcription to Markdown \& LaTeX, and AI-generated summaries \& quizzes.
}
\resumeItemListEnd
\newpage
\resumeProjectHeading
